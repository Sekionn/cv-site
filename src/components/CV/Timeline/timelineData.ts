...
export const schoolTimelineEvents: TimelineEvent[] = [
  {
    ...
    skillKeys: [
      "timeline.skill.communicationIt",
      "timeline.skill.english",
      "timeline.skill.programming",
    ],
    type: "school",
  ...
  },
  {
    ...
    skillKeys: [
      "timeline.skill.gameDevelopment",
      "timeline.skill.csharp",
    ],
    type: "school",
  ...
  },
  {
    ...
    skillKeys: [
      "timeline.skill.unity",
      "timeline.skill.programming",
      "timeline.skill.csharp",
      "timeline.skill.sql",
      "timeline.skill.unreal",
      "timeline.skill.gameDevelopment",
      "timeline.skill.scrum",
      "timeline.skill.cypress",
      "timeline.skill.e2e",
    ],
    type: "school",
  ...
  },
  {
    ...
    detailKeys: [
      ...
      "timeline.itSecurity.detail.crypto2",
    ],
    skillKeys: [
      "timeline.skill.networkSecurity",
      "timeline.skill.systemSecurity",
      "timeline.skill.cryptography",
  ...
  },
  {
    ...
    detailKeys: [
      ...
      "timeline.softwareDevelopment.detail.NuværendeSemester",
    ],
    skillKeys: [
      "timeline.skill.testing",
      "timeline.skill.softwareQuality",
      "timeline.skill.databases",
      "timeline.skill.appliedAI",
      "timeline.skill.LLM",
      "timeline.skill.largeSystems",
      "timeline.skill.systemintegration",
      "timeline.skill.eventbased",
      "timeline.skill.nosqldatabases",
      "timeline.skill.unittesting",
      "timeline.skill.integrationtesting",
      "timeline.skill.stresstesting",
      "timeline.skill.e2e",
      "timeline.skill.cypress",
      "timeline.skill.java",
      "timeline.skill.react",
      "timeline.skill.vite",
      "timeline.skill.k6",
      "timeline.skill.mongodb",
      "timeline.skill.neo4j",
      "timeline.skill.redis",
...
export const workTimelineEvents: TimelineEvent[] = [
  {
    ...
    skillKeys: [
      "timeline.skill.storeResponsibility",
      "timeline.skill.teamCoordination",
      "timeline.skill.customerService",
    ],
    type: "work",
  ...
  },
  {
    ...
    skillKeys: [
      "timeline.skill.aurelia",
      "timeline.skill.typescript",
      "timeline.skill.playwright",
      "timeline.skill.crossPlatformApp",
      "timeline.skill.flutter",
      "timeline.skill.cypress",
      "timeline.skill.frontenddevelopment",
      "timeline.skill.e2e",
    ],
    type: "work",
  ...
  },
  {
    ...
    skillKeys: [
      "timeline.skill.latteArt",
      "timeline.skill.climbing",
      "timeline.skill.independence",
      "timeline.skill.customerService",
    ],
    type: "work",
    connectToEventIds: null,
